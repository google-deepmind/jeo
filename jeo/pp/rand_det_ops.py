...
def get_det_roll(*, randkey1="rollx", randkey2="rolly"):
...
@pp_utils.InKeyOutKey(with_data=True)
def get_det_rotate90(*, randkey="angle"):
...
@pp_utils.InKeyOutKey(with_data=True)
def get_det_flip_rot(*, randkey="flip_rot"):
...
@pp_utils.InKeyOutKey(with_data=True)
def get_det_crop(crop_size: int, num_crops: int = 1, randkey="crop"):
